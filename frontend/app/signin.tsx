    ...
    <SafeAreaView className="flex-1 bg-white">
      ...
      >
        <ScrollView className="flex-1 px-6" showsVerticalScrollIndicator={false}>
          ...
          {/* Header */}
          <Text className="text-[32px] font-bold text-gray-900 tracking-tight mb-2">Welcome back</Text>
          <Text className="text-[15px] text-gray-500 mb-10">Sign in to access your history and settings.</Text>
          ...
          >
            {loading ? (
              ...
              <Text className="text-white font-bold text-[17px]">Sign In</Text>
            )}
          </TouchableOpacity>

          {/* Sign Up Link */}
          <TouchableOpacity onPress={() => router.replace("/signup")} className="items-center mb-10">
            <Text className="text-gray-500 text-[14px]">
              Don't have an account?{" "}
              <Text className="text-[#5267DA] font-semibold">Sign up</Text>
            </Text>
          </TouchableOpacity>
